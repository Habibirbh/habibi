...
export const campaignRegistry: CampaignMeta[] = [
  ...
  },
  {
    campaignId: 2n,
    slug: "elo-damac",
    name: "ELO — DAMAC Hills 2 (Proposed Acquisition)",
    emirate: "Dubai",
    location: "DAMAC Hills 2, Dubai",
    image: "elo",
    representativeImagery: false,
    mediaRightsStatus: "Licensed developer assets — verified ELO Damac documentation",
    summary:
      "Metropolitan Premium Properties is proud to present this stylish 1-bedroom apartment in Elo 1, Damac Hills 2. Property Details and Features: 1 bedroom, Community views, Modern open-plan living area, Fitted kitchen, Balcony, Covered parking, Swimming pools, Fully equipped gymnasium, Water town and leisure zones, Landscaped green spaces. Damac Hills 2 is a vibrant master community offering a mix of nature-inspired living and modern conveniences. It provides a peaceful lifestyle away from the city while still ensuring easy connectivity to key areas of Dubai.",
    indicativePrice: "AED 639,000",
    proposedAcquisitionPrice: "Final price set at acquisition authorization",
    acquisitionCostsBudget: "To be disclosed in campaign terms",
    contingency: "To be disclosed in campaign terms",
    proposedSPV: "To be confirmed before acquisition close",
    acquisitionStructure: "Property-holding SPV with contract-recorded fractional interests",
    facts: [
      { label: "Type", value: "Apartment · off-plan" },
      { label: "Bedrooms", value: "1" },
      { label: "Bathrooms", value: "1" },
      { label: "Plot area", value: "526 sqft" },
      { label: "Built-up area", value: "526 sqft" },
      { label: "Ownership", value: "Freehold" },
      { label: "Usage", value: "Residential" },
      { label: "Handover", value: "Q4 2026" },
      { label: "Masterplan completion", value: "~22% (as reported)" },
      { label: "Masterplan developer", value: "Front Line Investment Management" },
    ],
    amenities: [
      "Balcony or Terrace",
      "Centrally Air-Conditioned",
    ...
    config: {
      metadataURI: "habibi://campaign/elo-damac",
      termsURI: "REPLACE_WITH_APPROVED_TERMS_URI",
      termsHash: "REPLACE_WITH_APPROVED_TERMS_HASH",
      riskDisclosureURI: "REPLACE_WITH_APPROVED_RISK_DISCLOSURE_URI",
      proposedSPVIdentifier: "REPLACE_WITH_PROPOSED_SPV",
      ...
      acquisitionAuthorizationPolicy: "Authorizer role + signed acquisition certificate (multisig).",
      approvedImages: [
        "/elo-damac/image (6).jpg",
        "/elo-damac/image (7).jpg",
        "/elo-damac/image (8).jpg",
        "/elo-damac/image (9).jpg",
        "/elo-damac/image (10).jpg",
        "/elo-damac/image (11).jpg",
        "/elo-damac/image (12).jpg",
        "/elo-damac/image (13).jpg",
        "/elo-damac/image (14).jpg",
        "/elo-damac/840785167-1066x800.webp"
      ],
      imageRightsStatus: "Licensed developer assets — verified ELO Damac documentation",
    },
  },
];
